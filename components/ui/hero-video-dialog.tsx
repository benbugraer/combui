...
export default function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      <div
        className="relative cursor-pointer group rounded-md p-2 ring-1  bg-tertiary ring-tertiary backdrop-blur-md"
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md "
        />
