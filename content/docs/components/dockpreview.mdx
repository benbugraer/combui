...
For this component you can install `react-icons` for the icons. But you can use any icon library you want. Don't forget to customize the icons.
...
You can create `components/core/DockPreview.tsx` file and add this code.

```tsx title="DockPreview.tsx"
"use client";
...
```tsx title="dock-preview-usage.tsx"
...
That's all u can ready to use this component.
